...
public:
    ...
    const mpgIndex::picture &operator[](unsigned int i) const
    {
    ...
    int getpictureatposition(tvclipper_off_t position) const
    {
        ...
        tvclipper_off_t firstpos=idx[first].getpos();
        tvclipper_off_t lastpos=idx[last].getpos();
        tvclipper_off_t midpos;
    ...
    tvclipper_off_t getfilepos() const
    {
