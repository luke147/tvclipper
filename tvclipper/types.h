...
/* $Id: types.h 58 2007-07-23 07:03:07Z too-tired $ */

#ifndef _TVCLIPPER_TYPES_H
#define _TVCLIPPER_TYPES_H
...
private:
  uint64_t p;
public:
  filepos_t(tvclipper_off_t pos, uint32_t offset):p((pos<<24)|(offset&0xffffff))
    {}
  ...
  tvclipper_off_t packetposition() const
    {
    return (p>>24);
    }
  ...
  tvclipper_off_t fileposition() const
    {
